...
<?
	...
	$affiliate_sales_total2 = $affiliate_sales_total_res->row();
		...
		$cond1_total = array('affiliate_unreleased_payments.refid'=>$this->loggedInUser->user_name,'affiliate_unreleased_payments.is_released' => 0);
...
<div class="clsTabs clsInnerCommon clsInfoBox">
		 ...
		 ?>
								...
								if($affiliate_sales->num_rows == 0) { ?>
                                              ...
                                              <br>
                                              <p style="width:400px">Example: Welcome to <?php echo $site_title;?>. My name is <?php echo $this->loggedInUser->user_name; ?>. Feel free to contact me at <?php echo $this->loggedInUser->email; ?> if have any questions about using the site. Good Luck!</p>
