...
<div id="main">
  ...
  <div id="listProjects" class="clsInfoBox">
         <div class="slidetabsmenu menu_fix TabMenu50">
                    ...
                    <div class="main_br">
                      <div class="cls100_p">
                                              <div class="clsprogram1">
                                                <h2>FLPS Affiliate Program</h2>
                                                <h3 class="fsize TpSpace">Earn <?php echo $affiliate['buyer_affiliate_fee']+$affiliate['programmer_affiliate_fee']; ?>% Commission!</h3>
                                                <p class="fsize1">FLPS pays affiliates half the fees we charge users to participate in projects. If you refer a Buyer we will pay you
