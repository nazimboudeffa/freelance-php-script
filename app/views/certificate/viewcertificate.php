                          ...
                          <div id="selSignUp">
                            ...
                            <div class="clsInfoBox">
                              <div class="col-2 left Lspace">
                               ...
                               foreach($certificatebuyer as $certficates_buyer)
								...
								{
								?>
                                                          <h5> <a href="<?php echo site_url('buyer/viewProfile/'.$certficate_buyer->id) ?>"><?php echo $certficate_buyer->user_name;?></a><img src="<?php echo image_url('certified.gif');?>" /></h5>
                                                          </p>
                                                          <br>
                                                          <?php 
								}
                            ...
                            <div class="clsInfoBox">
                              <div class="col-2 left Lspace1">
								...
								{
								?>
                                                          <h5><a href="<?php echo site_url('programmer/viewProfile/'.$certficate_programmer->id) ?>"><?php echo $certficate_programmer->user_name;?></a><img src="<?php echo image_url('certified.gif');  ?>" /></h5>
                                                          </p>
