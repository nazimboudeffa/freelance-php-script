...
<div class="block">
      ...
      <form action="<?php echo site_url('certificate/addpackage'); ?>" name="viewpackage" id="viewpackage" method="post">        
		...
		<?php	}
			...
			<p><a name="edit" href="javascript: document.viewpackage.action='<?php echo site_url('certificate/addpackage'); ?>'; document.viewpackage.submit();"><img src="<?php echo image_url('bt_bl_apply.png'); ?>"/><?php //echo $this->lang->line('Apply Package');?></a></p>
