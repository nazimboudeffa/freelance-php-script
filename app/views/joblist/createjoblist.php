                                ...
                                <ul>
								  ...
								  <li class="clSNoBack">
									...
									<ul class="clsFloatedList clsClearFix clsMod2">
								 	 <li class="clsPercent30">
									 <input type="checkbox" <?php echo set_checkbox('is_private', '1'); ?> name="is_private" id="is_private" value="1" onclick="check_private(this.form)" /><b> <?php echo $this->lang->line('Private Invitation'); ?></b><br /> </li>
							  ...
							  <select name="salarytype" size="1">
								...
								<input class="clsMid" value="<?php echo $this->lang->line('Submit Job');?>" name="createProject" type="submit" />	
								  ...
								  <li class="clsDeatils">
									 ...
									 <input type="checkbox" name="is_private" value="1" onclick="check_private(this.form)" /><b> <?php echo $this->lang->line('Private Invitation'); ?></b><br /> </li>
									  <li class="clsRate"> $ <?php echo $hide_project; ?></li>
									  <li class="clsDescription"> <?php echo $this->lang->line('Private Messages'); ?><br /><br /><?php echo $this->lang->line('list'); ?></p></li>
									</ul>
									</li>
									<li>
									<ul class="clsLiFloat clsClearFix">
									  <li class="clsDeatils"><b><?php echo $this->lang->line('Invite Programmers'); ?></b><br /><br />
									   ...
									   <li class="clsRate"></li>
									  <li class="clsDescription"> <span><textarea name="private_list" id="private_listfill" rows="7" cols="30" disabled=""></textarea></span></li>
									 </ul> 
									</li>
									<li><?php */?>
...
//form.submit();
//window.open("<?php echo site_url('joblist/create'); ?>","myNewWin","width=500,height=300,toolbar=0"); 
}
