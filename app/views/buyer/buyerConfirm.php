                            ...
                            <div class="clsInnerCommon">
							  ...
							  <div id="selSignUp">
								<form method="post" action=""  enctype="multipart/form-data">
								  ...
								  <p><span><?php echo $this->lang->line('Pick a Username:');?></span>
								 ...
								 <p><?php if(form_error('username')) { echo '<span>&nbsp;</span>';echo form_error('username'); echo '<br>'; }?></p>	
								  ...
								  <p><span><?php echo $this->lang->line('Enter your password:');?></span>
									<input type="password" size="25" name="password"/>
									
								  </p>
								  <p><?php if(form_error('password')) { echo '<span>&nbsp;</span>';echo form_error('password'); echo '<br>'; }?></p>	
								  <p><span><?php echo $this->lang->line('Confirm Password:');?></span>
	...
	<div id="light" class="white_content"> 
		...
		<?php if(isset($page_content) and $page_content->num_rows()>0)
		 ...
		 <div id="fade" class="black_overlay"></div> 
								 ...
								 <?php /*?> <a href="javascript:;"    onclick="privacypopups();">
								  <?php echo $this->lang->line('Privacy Policy');?></a>
								  <?php echo $this->lang->line(')');?><?php */?>
								  
<?php /*?>								  <a href="<?php echo site_url('page/privacy');?>"></a>
<?php */?>								  <div id="selOptional">
									<ul>
		...
		<div id="fade1" class="black_overlay"></h3></div> 			
							...
							<?php /*?>	<a href="javascript:;" onclick="termspopups()"><?php echo $this->lang->line('FLPS Terms &amp; Conditions');?> </a>.<?php */?>
									<?php /*?><a href="#"> </a>.<?php */?>
