                        ...
                        <div class="grey_br padding0">
                          <div class="cls100_p ">
							<div class="clsInnerCommon">
							  ...
							  <?php /*?><p class="clsTopMar">Welcome <?php echo $loggedInUser->name?>!  <font color="#6b80a1">Local time </font><?php echo show_date(time()); ?></p><?php */?>
						      ...
						      foreach($transactions1->result() as $res)
								{  $i=$i+1; $k=$k+1;
								 ...
								 <!-- Inly for Debit Payments -->
								  ...
								  if($res->type == 'Project Fee' or $res->type == 'Withdraw' or $res->type =='Package Fee') 
								  {
