                      ...
                      <div class="cls100_p">
                            <div class="clsInnerCommon"> 
							 ...
							 <h3><span class="clsPMB"><?php echo $this->lang->line('My Open Projects');?></span></h3>
                              <?php
							   ...
							   <table cellspacing="1" cellpadding="2" width="96%">
                                ...
                                <tbody><tr>
                                  ...
                                  <td width="20%" class="dt"><!--<a href="<?php echo site_url('buyer/viewMyProjects/'.$page."/project_name/".$order);?>">--> <?php echo $this->lang->line('Project Name');?><!--</a>-->
                              <?php
							  ...
							  ?></td>
								  ...
								  <td width="10%" class="dt"><!--<a href="<?php echo site_url('buyer/viewMyProjects/'.$page."/created/".$order);?>">--><?php echo $this->lang->line('Posted');?><!--</a>-->
							  ...
							  ?></td>
								  ...
								  <td width="20%" class="dt" colspan="4"><?php echo $this->lang->line('Type');?></td>  <!--edited on Dec10-->
                                </tr>
								<?php
						  	if(isset($myProjects) and $myProjects->num_rows()>0)
							{
								...
								foreach($myProjects->result() as $myProjects)
								{
									...
									<td ><?php echo $i+1;?></td>
									  <?php /*?><span ="clsBids"><?php echo $i+1; ?></span><?php */?>
								   ...
								   if($myProjects->is_feature == 1) { ?>
									...
									if($myProjects->is_private == 1) {?>
									 ...
									 ?></td> <td> <?php echo $numbids = getNumBid($myProjects->id);?> </td><td> <?php echo getLowBid($myProjects->id);?> </td><td> <?php echo getBidsInfo($myProjects->id); ?></td> <td> <?php echo $numbids = getNumBid($myProjects->id);?> </td><td> <?php echo getLowBid($myProjects->id);?> </td><td> <?php echo getBidsInfo($myProjects->id); ?> </td><td>
									  <?php 
                          ...
                          <?php
						  	/*if(isset($closedProjects) and $closedProjects->num_rows()>0)
							{
								...
								foreach($closedProjects->result() as $closedProject)
								{
									...
									?>
                                   <tr class="<?php echo $class; ?>">
                                    <td><?php echo $i+1;?></td><td><a href="<?php echo site_url('project/view/'.$closedProject->id); ?>"><?php echo $closedProject->project_name; ?></a></td><td><a href="<?php echo site_url('programmer/viewProfile/'.$closedProject->userid);?>"><?php echo $closedProject->user_name; ?></a> </td><td> <?php echo getLowestBid($closedProject->id,$closedProject->programmer_id); ?> </td><td> <a href="<?php echo site_url('buyer/reviewProgrammer/'.$closedProject->id);?>"><?php echo $this->lang->line('Review');?></a></td></tr>
                          <?php		
						  			$i++;	
								 ...
								 if(is_object($reviewDetails))
							     {
								   ...
								   if($closedProject->is_feature == 1) { ?>
									...
									if($closedProject->is_private == 1) {?>
									 ...
									 <img src="<?php echo image_url('private.png');?>" width="14" height="14" title="private project" alt="<?php echo $this->lang->line('Private Project'); ?>" /><?php }
									 ?></td> <td> <?php echo $numbids = getNumBid($myProjects->id);?> </td><td> <?php echo getLowBid($myProjects->id);?> </td><td> <?php echo getBidsInfo($myProjects->id); ?></td><td><a href="<?php echo site_url('programmer/viewProfile/'.$closedProject->userid);?>"><?php echo $closedProject->user_name; ?></a>
								...
								foreach($bookMark->result() as $bookMark)
								{
								   ...
								   if($bookMark->is_feature == 1) { ?>
									...
									if($bookMark->is_private == 1) {?>
									 ...
									 <img src="<?php echo image_url('private.png');?>" width="14" height="14" title="private project" alt="<?php echo $this->lang->line('Private Project'); ?>" /><?php }
									 ?></td> <td> <?php echo $numbids = getNumBid($myProjects->id);?> </td><td> <?php echo getLowBid($myProjects->id);?> </td><td> <?php echo getBidsInfo($myProjects->id); ?></td>
