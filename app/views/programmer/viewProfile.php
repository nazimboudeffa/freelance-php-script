                      ...
                      <div class="cls100_p">
                            <div class="clsInnerCommon">
							 ...
							 <?php if (isset($loggedInUser->role_id)) {  ?>
							  ...
							  <img src="<?php echo image_url('ic_mail.png'); ?>" width="22" height="21" alt="Contact Programmer"/>
							  
							  </a>
							  
							  					  
							  <a href="<?php if (!isset($loggedInUser->role_id)) echo site_url('users/login'); else echo site_url('userList/inviteProgrammer/'.$user->id); ?>">
						       <img src="<?php echo image_url('ic_invite.png'); ?>" width="22" height="21" alt="Invite Programmer"/>
							  
							  </a>
							  
							   <?php } }?>
							 <?php  if (isset($loggedInUser->role_id)) { if ($loggedInUser->role_id=='1') { ?>
							  <a href="<?php echo site_url('userList/addFavouriteUsers/'.$user->id); ?>"><img src="<?php echo image_url('star.jpg'); ?>" width="22" height="21"  alt="Add To Favourite"/> </a>
							  <a href="<?php echo site_url('userList/addBlockedUsers/'.$user->id); ?>"><img src="<?php echo image_url('cross.jpg'); ?>" width="22" height="22" alt="BlackList User"/> </a><?php } } ?>
							...
							echo '(No Feedback Yet) ';
                              ...
                              <?php } ?></td>								  
								...
								<tr>
                                  ...
                                  <td class="dt1"><?php echo get_date($user->last_activity); ?></td>								  
