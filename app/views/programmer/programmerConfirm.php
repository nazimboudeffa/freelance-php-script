                      ...
                      <div class="cls100_p">
                            <div class="clsInnerCommon">
							  ...
							  <form method="post" action="" enctype="multipart/form-data">
							     ...
							     <p><span><?php echo $this->lang->line('pick_username'); ?> </span>
								  ...
								  <p><span><?php echo 'Confirm Password'; ?></span>
...
<?php echo $this->lang->line('(');?>	<span class="underLine"><a href = "javascript:void(0)" onclick ="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><?php echo $this->lang->line('Privacy Policy');?></a></span><?php echo $this->lang->line(')');?>
		...
		<div id="fade" class="black_overlay"></h3></div> 
								...
								<?php /*?><?php echo $this->lang->line('(');?><a href="#"><?php echo $this->lang->line('Privacy Policy');?></a><?php echo $this->lang->line(')');?></span></h3><?php */?>
                                <ul>
							  ...
							  <div id="selAreaExpertise">
							    <h3><span class="clsCategory"><?php echo $this->lang->line('area_of_expertise'); ?></span></h3>
									...
									<p><span><?php echo $this->lang->line('your_average_hourly_rate'); ?></span> <?php echo $this->lang->line('$');?>
								 ...
								 <p><?php if(form_error('country')) { echo '<span>&nbsp;</span>';echo form_error('country'); echo '<br>'; }  ?></p>
								  ...
								  <p class="underLine"><label style="color:red;">*</label>
									...
									<?php echo $this->lang->line('I have read and agree to the');?> 	<a href = "javascript:void(0)" onclick = "document.getElementById('light1').style.display='block';document.getElementById('fade1').style.display='block'"><?php echo $this->lang->line('FLPS Terms &amp; Conditions');?></a>
		...
		<div id="fade1" class="black_overlay"></p></div> 	
									<?php /*?><?php echo $this->lang->line('I have read and agree to the');?> <a href="#"><?php echo $this->lang->line('FLPS Terms &amp; Conditions');?></a>.</p><?php */?>
								 <p> <?php if(form_error('signup_agree_terms')) { echo '<span>&nbsp;</span>';echo form_error('signup_agree_terms'); echo '<br>'; } ?></p>
								  <?php /*?><p><label style="color:red;">*</label>
									<input type="checkbox" name="signup_agree_contact" value="1" <?php echo set_checkbox('signup_agree_contact', '1'); ?>/ >
									<?php echo $this->lang->line('I will NOT post contact information on my projects.');?></p><?php */?>
