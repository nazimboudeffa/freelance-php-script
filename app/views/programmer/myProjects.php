                      ...
                      <div class="cls100_p">
						  	...
						  	if(isset($biddingProjects) and $biddingProjects->num_rows()>0)
							{
                                ...
                                <tr>
                                  ...
                                  <td class="<?php echo $class;?>"><a href="<?php echo site_url('project/view/'.$latestProject->id); ?>"><?php echo $latestProject->project_name; ?></a><?php if($latestProject->is_urgent == 1) { ?>
						  	...
						  	if(isset($wonBids) and $wonBids->num_rows()>0)
							{
                               ...
                               <tr>
                                 <td class="<?php echo $class;?> dt0"><?php echo $i+1;?></td>
								  ...
								  <td class="<?php echo $class;?>"><?php echo getProjectStatus($wonBid->project_status);?></td>
								  <td class="<?php echo $class;?>"><?php echo get_date($wonBid->created);?></td> 
								  <td class="<?php echo $class;?>"><a href="<?php echo site_url('programmer/reviewBuyer/'.$wonBid->id);?>"><?php echo $this->lang->line('view review');?></a></td>
                                </tr>
                                <?php		
						  			$i++;
								 }							
