...
src="<?php echo image_url('flpstheme.jpg'); ?>"/></td>
  ...
  <option value="theme3" <?php  if($themename=='theme3') { echo 'SELECTED=SELECTED'; } ?>>Green Theme</option>
   ...
   <input type="hidden" value="1" name="change"/>
	...
	<td align="left" width="38%" valign="top"><a target="_blank" href="http://www.freelancephpscript.com/index.php/download_free/templates/37"><img border="0" src="<?php echo image_url('clickhere.jpg'); ?>" usemap="#Map"/></a></td>
  </tr>
</tbody></table>
</form></div>
</div>
