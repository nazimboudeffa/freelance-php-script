        ...
        <div class="block">
				...
				<span class="clsBookMark"><a class="buttonBlack" href="<?php if (!isset($loggedInUser->role_id)) echo site_url('users/login'); else echo site_url('bookMark/'.$project->id); ?>"><span><?php echo $this->lang->line('Book Mark'); ?></span></a></span>
						...
						<?php if($project->is_urgent ==1 or $project->is_feature == 1 or $project->is_private ==1) { ?>
                              ...
                              <tr>
                                ...
                                <td class="dt1"><a class="glow" href="<?php echo site_url('buyer/viewProfile/'.$project->userid);?>"><?php echo $project->user_name; ?></a>
         ...
         <td class="dt1"><?php echo $project->attachment_name; ?><a href="<?php echo site_url('project/download/'.$project->attachment_url);?>" class="clsDown"><img src="<?php echo base_url();?>app/css/images/download1.png" /></a></td>								  								
						  ...
						  {?>
						   <tbody>
                              ...
                              <tr>
                                <td class="dt1 dt0"><?php echo $this->lang->line('Project Creator');?>:</td>
                                <td class="dt1"><a class="glow" href="<?php echo site_url('buyer/viewProfile/'.$project->userid);?>"><?php echo $project->user_name; ?></a><?php $condition1=array('subscriptionuser.username'=>$loggedInUser->id);
         ...
         <td class="dt1"><?php echo $project->attachment_name; ?><a href="<?php echo site_url('project/download/'.$project->attachment_url);?>" class="clsDown"><img src="<?php echo base_url();?>app/css/images/download1.png" /></a></td>								  								
                        ...
                        <div class="clsInnerCommon">
                          ...
                          <div class="block">
                                              ...
                                              <table cellspacing="1" cellpadding="2" width="96%">
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td width="10%" class="dt"><?php echo $this->lang->line('Time of Bid');?></td>
                                                    <td width="15%" class="dt"><?php echo $this->lang->line('Rating');?></td>
													<td width="5%" class="dt"><?php echo $this->lang->line('');?></td>
							...
							?>
												  ...
												  <?php  
												   $condition=array('subscriptionuser.username'=>$bid->user_id);
			$certified1= $this->certificate_model->getCertificateUser($condition);
										    ...
										    if($result->user_id == $bid->user_id)
											  {
												...
												if($result->user_role == '2')
													{ ?>
													  ...
													  <?php $condition1=array('subscriptionuser.username'=>$result->user_id);
								$certified1= $this->certificate_model->getCertificateUser($condition1);
								if($certified1->num_rows()>0)
			                    {
									// get the validity
						  ...
						  <td>
						    <?php /* if($bid->requiredescrow =='1')

							   { ?>
							   <img src="<?php echo image_url('escrow_icon1.png'); ?>" title="<?php echo $bid->user_name.' only accepts payment via '.$this->config->item('site_title').' escrow'; ?>" alt="<?php echo $bid->user_name.' only accepts payment via '.$this->config->item('site_title').' escrow'; ?>" />
