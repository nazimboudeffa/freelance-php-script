...
>>>>>>> .r6903
							...
							<?php /*?>	<p><?php echo '<span style="color:red"><b> * </b>'.$this->lang->line('Fields are Mandatory').'</span>'; ?></p>
							<?php */?>  
								...
								<!--OPTION LIST end here-->
								  ...
								  <li class="clsPercent30">
									 ...
									 <input type="checkbox" name="is_private" value="1" onclick="check_private(this.form)" <?php if($draft->is_private == '1') echo 'checked';?> /><b> <?php echo $this->lang->line('Private Invitation'); ?></b><br /> </li>
