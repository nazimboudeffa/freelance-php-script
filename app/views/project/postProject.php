                        ...
                        <div class="inner_br">
                          <div class="cls100_p">
                            <div class="clsInnerCommon clsSitelinks">
                              <h2><?php echo $this->lang->line('POST A PROJECT ON FLPS');?></h2>
                                      ...
                                      <li class="clsPercent30">
                                        <h5>
                                         <input  name="is_hide_bids" value="1" type="checkbox" <?php if (isset($postSimilar->is_hide_bids)) if ($postSimilar->is_hide_bids == 1) echo 'checked'; ?> <?php //echo set_checkbox('is_hide_bids', '1'); ?> />
                                          <?php echo $this->lang->line('Hide Project Bids');?> <a target="_blank" href="#"> <?php /*?><img height="13" border="0" width="16" title="" alt=" <?php echo $this->lang->line('Hide Project Bids');?>" src="<?php echo image_url('featured2.gif'); ?>"/><?php */?></a></h5>
                                      </li>
