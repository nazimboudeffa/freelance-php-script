                        ...
                        <div class="cls100_p">
						  ...
						  <form method="post" action="<?php echo site_url('users/login'); ?>">
							...
							<?php if(!empty($memeber_name)){?>
							 ...
							 class="clsText" id="UsernamePlace" onfocus="javascript:SwapUsername();" style="color:#000;"/>
							 <?php } else{?>
							 <input type="text" name="username" value="" class="clsText" id="Username" onblur="SwapUsernamePlace();" style="display:none;"/>
						      <input type="text" value="Username" class="clsText" id="UsernamePlace" onfocus="javascript:SwapUsername();" style="color:#000;"/>
							 <?php }?>
							...
							<input type="password" value="<?php if(!empty($memeber_pwd)){
							 ...
							 echo "Password";
							 }?>" class="clsText" onfocus="javascript:SwapPassword();" id="PasswordPlace" style="color:#000;"/>
							 ...
							 <?php }else {?>
							<input type="text" value="Password" class="clsText" onfocus="javascript:SwapPassword();" id="PasswordPlace" style="color:#000;"/>
                             <input type="password" name="pwd" value="" class="clsText" onblur="SwapPasswordPlace();" style="display:none;" id="Password"/>
							 <?php } ?>
                            </p>
							
							<!--				 Puhal Changes Commented the following lines to remove the buyer and programmer radio button (Sep 17 Issue 4)		
-->  
			
                          <?php /*?><p class="clsLeftSpace">
                              <input type="radio" name="utype" value="1" checked="checked"/>
                              <label><?php echo $this->lang->line('Buyer');?></label>
							  <input type="radio" name="utype" value="2"/>
                              <label><?php echo $this->lang->line('Provider');?></label>
                            </p><?php */?>
							<!--	 Puhal Changes  to add the Remember me button (Sep 17 Issue 3)	-->  			
