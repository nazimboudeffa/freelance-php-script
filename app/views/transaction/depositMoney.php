...
<p>
  <!--<input type="submit" value="Deposit" name="depositMoney" class="clsLogin"/>-->
                        ...
                        <label><?php echo $this->lang->line('Paypal') ?></label></td>
                                  <td class="dt1 dt0"><?php echo $this->lang->line('No Cost');?></td>
                                  <td class="dt1 dt0"><?php echo $this->lang->line('Instant*');?></td>
                                  <td class="dt1 dt0"><?php echo $this->lang->line('wire');?></td>
                                </tr>
