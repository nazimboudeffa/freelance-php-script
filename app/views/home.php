                    ...
                    <div class="main_br">
                      <div class="cls100_p">
                            ...
                            <div class="alignRight">
                              <p><a href="<?php echo site_url('buyer/getBuyersreview'); ?>"><img src="<?php echo image_url('bt_viewall.png');?>" width="116" height="21" alt="view all" /></a></p>
                            </div>
                            <?php } 
                  ...
                  <div class="main_bl">
                    <div class="main_br">
                      <div class="cls100_p">
                            ...
                            <?php } ?>
                            <div class="alignRight">
                              <p><a href="<?php echo site_url('programmer/getProgrammersreview');?>"><img src="<?php echo image_url('bt_viewall.png');?>" width="116" height="21" alt="view all" /></a></p>
                            </div>
                            <?php } 
