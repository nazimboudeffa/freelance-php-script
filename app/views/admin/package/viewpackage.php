...
<div id="main">
  <div class="clsSettings">
	...
	<?php echo $this->lang->line('With Selected'); ?>
           ...
           <a name="delete" href="javascript: document.managePackage.action='<?php echo admin_url('packages/deletePackage'); ?>'; document.managePackage.submit();"><img src="<?php echo image_url('delete-new.png'); ?>" alt="Delete" title="Delete" /></a></div>
    </div>
  </div>
