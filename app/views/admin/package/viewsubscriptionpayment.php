...
<div id="main">
  <div class="clsSettings">
	...
	<form action="<?php echo admin_url('packages/managesubscriptionuser'); ?>" name="managePackage" id="managePackage" method="post" >
		...
		if(isset($subscriberpaymentdetails))
		{
		foreach($subscriberpaymentdetails as $subscriberdetail)
			{
			foreach($subscriberdetail->result() as $subscriberdetails)
			{
		?>
          <tr>
	  ...
	  <div id="selLeftAlign">
	<?php /*?><?php echo $this->lang->line('With Selected'); ?>
		  <!-- <a name="edit" href="javascript: document.managePackage.action='<?php echo admin_url('packages/managesubscriptionuser'); ?>'; document.managePackage.submit();"><img src="<?php echo image_url('edit-new.png'); ?>" alt="Edit" title="Edit" /></a>-->
           <a name="delete" href="javascript: document.managePackage.action='<?php echo admin_url('packages/deleteSubscriptionUser'); ?>'; document.managePackage.submit();"><img src="<?php echo image_url('delete-new.png'); ?>" alt="Delete" title="Delete" /></a><?php */?></div>
    </div>
  </div>
