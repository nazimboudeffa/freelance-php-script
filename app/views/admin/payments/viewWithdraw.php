...
<div id="main">
  <div class="clsSettings">
    ...
    <div class="clsMidWrapper">
	  ...
	  <br />
      <div class="clsTab">
       <?php /*?> <ul class="clsClearFixSub clsBg">
          <li class="clsNo"><?php echo $this->lang->line('Sl.No'); ?></li>
          <li class="clsMailId"><?php echo $this->lang->line('Description'); ?></li>
		  <li class="clsName"><?php echo $this->lang->line('Transaction From'); ?></li>
	      <li class="clsMailId"><?php echo $this->lang->line('Transaction To'); ?></li>
	      <li class="clsTen"><?php echo $this->lang->line('Amount'); ?></li>
          <li class="clsMailId"><?php echo $this->lang->line('Date'); ?></li>
          <li class="clsTen"><?php echo $this->lang->line('Status'); ?></li>
		  <li class="clsTen"></li>
        </ul><?php */?>
		...
		?>
			...
			<!-- <td><?php echo $transactions->type; ?></td>
			      <?php foreach($usersList->result() as $users) { if($users->id == $transactions->creator_id) {?>
			      <td><a href="<?php echo site_url().$transactions->creator_id; ?>"><?php echo $users->user_name; ?></a></td>-->
			      <?php } } ?>	  
			 <td> <?php
