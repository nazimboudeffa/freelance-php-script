...
<div class="clsContainer">
   ...
   <div id="selLeftHeader" class="clsFloatLeft">
     ...
     <h1 class="logo"> <a href="<?php echo admin_url('home'); ?>"> </a></h1>
	 </div>
  ...
  <div id="sellogin">
    ...
    <?php /*?><form method="post" action="">
		  <p class="clsClearFixSub">
			<label><?php echo $this->lang->line('username'); ?><span class="red">*</span></label>
			<input class="clsAdminTextBox" type="text" name="username" value="<?php echo set_value('username'); ?>"/>
			<?php echo form_error('username'); ?></p>
		  <p>
			<label><?php echo $this->lang->line('password'); ?><span class="red">*</span></label>
			<input class="clsAdminTextBox" type="password" name="pwd" value=""/>
			<?php echo form_error('pwd'); ?> </p>
		  <p class="clsSubmitBlock">
			<input class="clsSubmitBt1" value="Submit" name="loginAdmin" type="submit">
		  </p>
		</form><?php */?>
    <!--CONTENT-->
    <div class="innercontent">
      <h2><?php echo $this->lang->line('Member Area');?> - <?php echo $this->lang->line('login'); ?> </h2>
      <?php /*?> <h3><?php echo $this->lang->line('login'); ?></h3><?php */?>
