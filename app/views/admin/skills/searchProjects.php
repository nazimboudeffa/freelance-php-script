...
<div id="main">
  <div class="clsSettings">
    ...
    <div class="clsMidWrapper">
	  ...
	  <?php /*?><tr><td><label><?php echo $this->lang->line('Choose Keyword Type'); ?></label></td><td>
	  <select name="search" id="search" onchange="javascript:searchtype()">
	  	<option value="id">Project Id</option>
		<option value="nmae">Project Name</option>
	  </select>
	  </td></tr><?php */?>
	   <div class="clsTable">
