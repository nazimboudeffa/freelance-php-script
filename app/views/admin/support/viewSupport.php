  ...
  <div class="clsSettings">
    ...
    <div class="clsMidWrapper">
      ...
      <div class="clsTop clsClearFixSub">
         <div class="clsNav">
          <ul>
        <?php /*?>    <li><a href="<?php echo admin_url('faq/viewFaqCategories')?>"><?php echo $this->lang->line('view_faq_categories'); ?></a></li>
			<li><a href="<?php echo admin_url('faq/addFaqCategory')?>"><?php echo $this->lang->line('add_faq_category'); ?></a></li>
			<li class="clsNoBorder"><a href="<?php echo admin_url('faq/addFaq')?>"><?php echo $this->lang->line('add_faq'); ?></a></li><?php */?>
          </ul>
        </div>
		<div class="clsTitle">
			 ...
			 <tr>
			  ...
			  <td width="2%"><?php echo $support1->priority; ?></td>
			   ...
			   <td width="14%">
				...
				{ ?>
				  <a title="Display" class="icon edit tip" href="<?php echo admin_url('support/close/'.$support1->id) ?>"><img src="<?php echo image_url('enable.png'); ?>" alt="Enable" title="Closed" /></a> <?php ?>
			<?php }
				else {   ?>
				  <a title="Display" class="icon edit tip" href="<?php echo admin_url('support/open/'.$support1->id); ?>"><img src="<?php echo image_url('disable.png'); ?>" alt="Disable" title="Open" /></a> 
				 <?php } ?> 				
