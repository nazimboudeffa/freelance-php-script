...
if(isset($projects))
{
	foreach($projects->result() as $project)
	{
	  ...
	  if($days == 0)
	    {
			$todayProject = $todayProject + 1;
			//Get latest open projects
			if($project->project_status == '0')
			  {
			  	$todayOpen = $todayOpen + 1;
			  }
			//Get latest closed projects  
			if($project->project_status == '1')
			  {
			  	$todayClosed = $todayClosed + 1;
			  }  
		}	
	  //Get this week projects	
	  if($days < 8)
	    {
			$weekProject = $weekProject + 1;
		}	
	
	  //Get this year projects	
      if($days < 30)
	    {
			$monthProject = $monthProject + 1;
		}	
		
	  //Get this year projects	
      if($days < 366)
	    {
			$yearProject = $yearProject + 1;
		}	
	}
    ...
    <div id="main">
      ...
      <p><img src="<?php echo image_url('chat.gif'); ?>" height="40" width="45" alt="img" /></p>
            ...
            <div class="selQuickStatusRight clsFloatRight">
             ...
             <li class="clspros clear"><table width="300"><tr><td width="60%"><?php echo $this->lang->line('Total Programmers'); ?> :</td> <td width="10%"> <?php if(isset($programmers)) echo $programmers; ?></td><td width="30%"><a href="<?php echo admin_url('users/viewProgrammeruser'); ?>"> <?php echo $this->lang->line('Members'); ?></a></td></tr></table></li>
			  ...
			  <li class="clsToday"><table width="300"><tr><td width="60%"><?php echo $this->lang->line('Today'); ?> : </td> <td width="10%"><?php if(isset($today)) echo $today; ?></td><td width="30%"><a href="<?php echo admin_url('skills/todayProjects'); ?>">  <?php echo $this->lang->line('Projects'); ?></a></td></tr></table></li>
                ...
                <li class="clsReport"><table width="300"><tr><td width="60%"><?php echo $this->lang->line('Report Violation'); ?> :</td> <td width="10%"> <?php if(isset($reportViolation)) echo $reportViolation; ?></td><td width="30%"><a href="<?php echo admin_url('skills/reportViolation'); ?>"> <?php echo $this->lang->line('Projects'); ?></a></td></tr></table></li>			
                 ...
                 <li class="clsOpenPros clear"><table width="300"><tr><td width="60%"><?php echo $this->lang->line('Withdrawal Request'); ?> : </td> <td width="10%"><?php if(isset($withdraw)) echo $withdraw; ?></td><td width="30%"><a href="<?php echo admin_url('payments/viewWithdraw'); ?>"><?php echo $this->lang->line('View'); ?></a></td></tr></table></li>
				 
                 <!--<li class="clssquare"><a href="#">My del.icio.us bookmarks</a></li>-->
...
<!--		  <div class="selQuickStatus clearfix">
            <div class="selQuickStatusleft clsFloatLeft">
              <p><img src="<?php //echo image_url('camera.gif'); ?>" height="49" width="47" alt="img" /></p>
            </div>
            <div class="selQuickStatusRight clsFloatRight">
              <h2>Awaiting Moderations</h2>
               <ul class="clearfix">
                <li class="clsMember"><a href="#">My del.icio.us<span> bookmarks</span></a></li>
                <li class="clsbook"><a href="#">My del.icio.us bookmarks</a></li>
                 <li class="clssquare"><a href="#">My del.icio.us bookmarks</a></li>
               	<div class="clear"></div>
				<li class="clsgraph"><a href="#">My del.icio.us bookmarks</a></li>
                <li class="clsMember"><a href="#">My del.icio.us bookmarks</a></li>
                 <li class="clsmen"><a href="#">My del.icio.us<span> bookmarks</span></a></li>
               	<div class="clear"></div> 
				<li class="clsbook"><a href="#">My del.icio.us <span>bookmarks</span></a></li>
                <li class="clscar"><a href="#">My del.icio.us <span>bookmarks</span></a></li>
                 <li class="clsmusic"><a href="#">My .us bookmarks</a></li>
               	<div class="clear"></div>
				        <li class="clscalender"><a href="#">My del.icio.us bookmarks</a></li>
                <li class="clsbook1"><a href="#">My del.icio.us <span>bookmarks</span></a></li>
                 <li class="clsflim"><a href="#">My del.icio.us bookmarks</a></li>
               	<div class="clear"></div>
