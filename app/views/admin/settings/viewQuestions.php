...
<div id="main">
  <div class="clsSettings">
	...
	<?php echo $this->lang->line('With Selected'); ?>
		   <a name="edit" href="javascript: document.manageQuestions.action='<?php echo admin_url('affiliateSettings/manageQuestions'); ?>'; document.manageQuestions.submit();"><img src="<?php echo image_url('edit-new.png'); ?>" alt="Edit" title="Edit" /></a>
		   ...
		   <a name="archive" href="javascript: document.manageQuestions.action='<?php echo admin_url('affiliateSettings/archiveQuestions'); ?>'; document.manageQuestions.submit();"><img src="<?php echo image_url('archive.png'); ?>" alt="Delete" title="Archive" width="20" height="20"/></a></div>
	<!--PAGING-->
