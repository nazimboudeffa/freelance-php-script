...
<div id="main">
  <div class="clsSettings">
	...
	<?php echo $this->lang->line('With Selected'); ?>
		   <a name="edit" href="javascript: document.manageArchives.action='<?php echo admin_url('affiliateSettings/manageArchives'); ?>'; document.manageArchives.submit();"><img src="<?php echo image_url('edit-new.png'); ?>" alt="Edit" title="Edit" /></a>
           <a name="delete" href="javascript: document.manageArchives.action='<?php echo admin_url('affiliateSettings/deleteArchives'); ?>'; document.manageArchives.submit();"><img src="<?php echo image_url('delete-new.png'); ?>" alt="Delete" title="Delete" onClick="javascript:return confirm(' Are you sure to delete this category?');" /></a>
		  </div>
	<!--PAGING-->
