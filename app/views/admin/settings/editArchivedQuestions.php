		...
		foreach($list as $res) 
		 {
			foreach($res->result() as $rec)
			  ...
			  <tr><td><label><b><?php echo 'Email'; ?></b></label></td><td><input type="text" name="email[]" value="<?php echo $rec->email; ?>" /></td></tr>
			  <tr><td><label><b><?php echo $this->lang->line('Email Subject'); ?></b></label></td><td> <input type="text" name="subject[]" value=" <?php echo $rec->subject; ?>"> </td></td>
