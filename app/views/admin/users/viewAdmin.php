    ...
    <div class="clsMidWrapper">
	  ...
	  <?php echo $this->lang->line('With Selected'); ?>
		  <!-- <a name="edit" href="javascript: document.manageBids.action='<?php echo admin_url('users/manageAdmin'); ?>'; document.manageBids.submit();"><img src="<?php echo image_url('edit-new.png'); ?>" alt="Edit" title="Edit" /></a>-->
           <a name="delete" href="javascript: document.manageBids.action='<?php echo admin_url('users/deleteAdmin'); ?>'; document.manageBids.submit();" onclick="return confirm('Are you sure want to delete??');"><img src="<?php echo image_url('delete-new.png'); ?>" alt="Delete" title="Delete" /></a> </div>
	  <!--PAGING-->
