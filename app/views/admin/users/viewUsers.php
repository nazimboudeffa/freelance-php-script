       ...
       <table width="700" class="table">
		...
		<form name="manageuserdetail" action="" method="post" >
          <tr>
			...
			<a title="Delete" <?php /*?>class="confirm icon delete tip"<?php */?> href="<?php echo admin_url('users/deleteUser/'.$userDetail->id);?>" onclick="return confirm('Are you sure want to delete??');"><img src="<?php echo image_url('delete-new.png'); ?>" alt="Delete" title="Delete" /></a> </td>
          </tr>
		  <?php }
		  }
		  else{ ?>
