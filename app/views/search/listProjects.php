                              ...
                              <tr class="<?php echo $class; ?>">
                                ...
                                <td><a href="<?php echo site_url('project/view/'.$project->id); ?>"> <?php echo highlight_phrase($project->project_name,$keyword,'<b>','</b>')?></a>
								 <?php if($project->is_urgent == 1) { ?>
								  <img src="<?php echo image_url('urgent2.gif');?>" width="14" height="14" title="Urgent project" alt="Urgent project" />
								   <?php } 
								   if($project->is_feature == 1) { ?>
								    <img src="<?php echo image_url('featured2.gif');?>" width="14" height="14" title="Featured project" alt="Featured project" />
								   <? } ?>
								</td>
                                <?php if($this->session->userdata('show_cat')):	?>
