 ...
 if($this->input->post('change'))   //theme change in footer
		{
			...
			$themeurl['theme1']='http://demo.FreelancePHPScript.com/flps/';
			$themeurl['theme2']='http://demo.freelancephpscript.com/free/flps/flps1.6/template001/script/skin001/';
			$themeurl['theme3']='http://demo.freelancephpscript.com/free/flps/flps1.6/template002/script/skin002/';
