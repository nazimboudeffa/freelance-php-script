...
<div id="header">
  <!--RC for Logo-->
                  ...
                  <div class="top_bl">
                    <div class="top_br">
                      <div class="cls100_p" >
                        ...
                        <h1><a href="http://FreelancePHPScript.com" target="_blank">FLPS</a></h1>
						</div>
						</div>
                        <!--RC-->
                      </div>
	...
	if(!version_compare(phpversion(), '5.0', '>=')) {
		echo 'OOps!! <strong>Installation error:</strong> in order to run FLPS you need PHP5. Your current PHP version is: ' . phpversion();
	} 
	else
	{
		if(isset($error))
    ...
    ?>
	  ...
	  <div id="footer">
	<p>www.freelancephpscript.com</p>
</div>              </div>
    <!--end of RC-->
